...
Window::Window(SDL_Renderer* Renderer, int x_, int y_, int w_, int h_) {
    tresize.loadFromFile(Renderer, "..//SDL2//ui//resize.png");
    tclose.loadFromFile(Renderer,"..//SDL2//ui//close.png");
    tmin.loadFromFile(Renderer,"..//SDL2//ui//min.png");
    x=x_;
    y=y_;
    width=w_;
    height=h_;
...
SDL_Rect Window::returnUsuableViewport() {
    SDL_Rect tmp;
    tmp.x=x+1; tmp.y=y+6; tmp.w=width-2; tmp.h=height-6;
    return tmp;
}
